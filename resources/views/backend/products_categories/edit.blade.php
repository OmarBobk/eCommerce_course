    ...
    <div class="card shadow mb-4 mx-3">
        ...
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary" style="line-height:38px;">
                Edit Categories {{$productCategory->name}}
            </h6>
            <div class="ml-auto">
        ...
        {{--Form--}}
        <div class="card-body">
            <form action="{{route('admin.product_categories.update', $productCategory->id)}}"
                  method="POST"
                    ...
                    <div class="col-3">
                        ...
                        <select name="parent_id" class="form-control">
                            ...
                            @forelse($main_categories as $category)
                                <option value="{{$category->id}}" {{old('parent_id', $productCategory->parent_id) == $category->id ? 'selected' : null}}>
                                    {{$category->name}}
                                </option>
                            @empty
                            @endforelse
                    ...
                    <div class="col-12">
                        ...
                        <div class="file-load">
                            <input type="file" name="cover"
                                   value="{{asset('assets/product_categories/').'/'. old('cover', $productCategory->cover)}}"
                                   id="category-images" class="form-control`">
